export const CardListLoadingSkeleton = () => {

    return (
        <div className='right-0   flex flex-row flex-wrap    '>
            {
                Array.from({ length: 4 }).map((_, i) => (
                    <div role="status" className={` animate-pulse  w-full  py-0 mb-10   flex`}
                        key={i}>

                        <div className="flex items-center justify-center h-52  bg-gray-300 rounded dark:bg-gray-700  w-80">
                        ...
                        <div className="flex  flex-col   flex-grow px-8 ">
                            ...
                            <div className="h-2 bg-gray-200 rounded-full dark:bg-gray-700 mb-2.5 w-5/6"></div>
                            <div className="h-2 bg-gray-200 rounded-full dark:bg-gray-700 mb-2.5 w-5/6 "></div>
