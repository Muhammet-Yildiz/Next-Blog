      ...
      <div className='fixed left-0  h-full lg:w-6/12 w-full '  >
        <div className="flex  flex-col justify-center items-center  h-screen  bg-slate-50 dark:bg-black">
          ...
          <div className="sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <h2 className="mt-8 text-center text-lg font-semibold leading-4 tracking-tight text-gray-700 font-sans dark:text-neutral-400 ">
            ...
            <div className="mt-6">
              ...
              <div className="mt-6 grid grid-cols-2 gap-3">
                ...
                <div
                 ...
                 cursor-pointer
                 transition duration-400 ease-in-out dark:bg-zinc-800/70 dark:text-zinc-400
          ...
          {`Don't have an account yet?`}
            <a href="/register" className="font-semibold leading-6 text-violet-600 hover:text-indigo-500 ml-[10px] dark:text-violet-500/80" >
              Sign up
            </a>
          </p>
        </div>
